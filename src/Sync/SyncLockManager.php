...
SQL;
    ...
    /**
     * Mehrfachaufrufe innerhalb desselben Prozesses verwenden
     * denselben bereits gehaltenen Datenbank-Lock.
     *
     * @template TResult
     *
    ...
    private function release(): void
    {
        try {
            ...
            if (
                ...
                $this->logger->warning(
                    'WSS Lineup synchronization lock was not released.'
                );
            }
        } catch (Throwable $exception) {
            if ($this->logger !== null) {
                $this->logger->warning(
                    'WSS Lineup synchronization lock release failed.',
                    [
